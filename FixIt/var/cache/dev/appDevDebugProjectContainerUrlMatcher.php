    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/p')) {
            if (0 === strpos($pathinfo, '/publication')) {
                ...
                // pub_demandeur
                if (0 === strpos($pathinfo, '/publication/pub') && preg_match('#^/publication/pub/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'pub_demandeur']), array (  '_controller' => 'PublicationBundle\\Controller\\PublicationController::pubParDemandeurAction',));
                }

                // publication_new
                if ('/publication/new' === $pathinfo) {
                    return array (  '_controller' => 'PublicationBundle\\Controller\\PublicationController::newAction',  '_route' => 'publication_new',);
                }
                ...
                // add_publication
                if (0 === strpos($pathinfo, '/publication/addPublication') && preg_match('#^/publication/addPublication/(?P<id_prof>[^/]++)/(?P<id_publication>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'add_publication']), array (  '_controller' => 'PublicationBundle\\Controller\\PublicationController::postulerAction',));
                }

                // pub_prof
                if (0 === strpos($pathinfo, '/publication/pubprof') && preg_match('#^/publication/pubprof/(?P<id_prof>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'pub_prof']), array (  '_controller' => 'PublicationBundle\\Controller\\PublicationController::pubParMetierAction',));
                }

                // update_pub
                if (0 === strpos($pathinfo, '/publication/updatepub') && preg_match('#^/publication/updatepub/(?P<id_pub>[^/]++)/(?P<id_prof>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'update_pub']), array (  '_controller' => 'PublicationBundle\\Controller\\PublicationController::UpdatePublicationAction',));
                }

                // cloturer_pub
                if (0 === strpos($pathinfo, '/publication/cloturer') && preg_match('#^/publication/cloturer/(?P<id_pub>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'cloturer_pub']), array (  '_controller' => 'PublicationBundle\\Controller\\PublicationController::cloturerAction',));
                }
        ...
        if (0 === strpos($pathinfo, '/get')) {
            // createUserDepla
            if ('/getAlldeplacementByUser' === $pathinfo) {
                return array (  '_controller' => 'PortfolioBundle\\Controller\\DefaultController::showByUsernameByDep',  '_route' => 'createUserDepla',);
            }

            if (0 === strpos($pathinfo, '/getAllUsr')) {
                // listAllUSER
                if ('/getAllUsr' === $pathinfo) {
                    return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::getAllUser',  '_route' => 'listAllUSER',);
                }

                // listAllUSR
                if (preg_match('#^/getAllUsr/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                ...
                // listUserDept
                if (0 === strpos($pathinfo, '/getAllUsrByDep') && preg_match('#^/getAllUsrByDep/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'listUserDept']), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::getAllUserBydeplacemeny',));
                }

                // listUserMett
                if (0 === strpos($pathinfo, '/getAllUsrByMet') && preg_match('#^/getAllUsrByMet/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'listUserMett']), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::getAllUserByMetier',));
                }
        ...
        if (0 === strpos($pathinfo, '/feedback')) {
            // evaluation_default_add
            if (0 === strpos($pathinfo, '/feedback/add') && preg_match('#^/feedback/add/(?P<idprof>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, ['_route' => 'evaluation_default_add']), array (  '_controller' => 'EvaluationBundle\\Controller\\DefaultController::addAction',));
            }

            // evaluation_default_update
            if (0 === strpos($pathinfo, '/feedback/update') && preg_match('#^/feedback/update/(?P<idprof>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, ['_route' => 'evaluation_default_update']), array (  '_controller' => 'EvaluationBundle\\Controller\\DefaultController::updateAction',));
            }

            // evaluation_default_deleteevaluation
            if (0 === strpos($pathinfo, '/feedback/delete') && preg_match('#^/feedback/delete/(?P<idprof>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, ['_route' => 'evaluation_default_deleteevaluation']), array (  '_controller' => 'EvaluationBundle\\Controller\\DefaultController::deleteEvaluationAction',));
            }

            // evaluation_default_getfeedback
            if (0 === strpos($pathinfo, '/feedback/getfeedback') && preg_match('#^/feedback/getfeedback/(?P<idprof>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, ['_route' => 'evaluation_default_getfeedback']), array (  '_controller' => 'EvaluationBundle\\Controller\\DefaultController::getFeedback',));
            }
