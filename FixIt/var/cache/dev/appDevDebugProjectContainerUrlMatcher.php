...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/api')) {
            ...
            // createUser
            if ('/api/show' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::showUser',  '_route' => 'createUser',);
            }
        ...
        elseif (0 === strpos($pathinfo, '/l')) {
            // createUserby
            if ('/list' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::showUserby',  '_route' => 'createUserby',);
            }
