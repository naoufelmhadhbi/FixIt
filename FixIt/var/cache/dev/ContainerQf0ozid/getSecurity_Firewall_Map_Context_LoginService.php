...
return $this->services['security.firewall.map.context.login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 1 => ${($_ = isset($this->services['security.authentication.listener.form.login']) ? $this->services['security.authentication.listener.form.login'] : $this->load('getSecurity_Authentication_Listener_Form_LoginService.php')) && false ?: '_'};
