...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'appbundle\\controller\\demandeurcontroller' => 'AppBundle\\Controller\\DemandeurController',
            'appbundle\\controller\\professionnelcontroller' => 'AppBundle\\Controller\\ProfessionnelController',
            'appbundle\\service\\validate' => 'AppBundle\\Service\\Validate',
            'appbundle\\userservices\\userservice' => 'AppBundle\\UserServices\\UserService',
            ...
            'portfoliobundle\\controller\\defaultcontroller' => 'PortfolioBundle\\Controller\\DefaultController',
        ...
        $this->fileMap = [
            ...
            'AppBundle\\Controller\\DemandeurController' => 'getDemandeurControllerService.php',
            'AppBundle\\Controller\\ProfessionnelController' => 'getProfessionnelControllerService.php',
            'AppBundle\\Service\\Validate' => 'getValidateService.php',
            'AppBundle\\UserServices\\UserService' => 'getUserServiceService.php',
            ...
            'PortfolioBundle\\Controller\\DefaultController' => 'getDefaultController2Service.php',
            ...
            'service_locator.3qmptsx' => 'getServiceLocator_3qmptsxService.php',
            'service_locator.ol3yfvt' => 'getServiceLocator_Ol3yfvtService.php',
            'service_locator.qgay0fs' => 'getServiceLocator_Qgay0fsService.php',
        ...
        $this->privates = [
            ...
            'AppBundle\\Service\\Validate' => true,
            ...
            'service_locator.3qmptsx' => true,
            'service_locator.ol3yfvt' => true,
            'service_locator.qgay0fs' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MJ+A0uNtct', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vrLYq+CBAm', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sy+RPRFH7-', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V6Tl-hfof2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ReclamationBundle/Resources/views'), '!Reclamation');
        $instance->addPath(($this->targetDirs[3].'\\src\\EvaluationBundle/Resources/views'), 'Evaluation');
        $instance->addPath(($this->targetDirs[3].'\\src\\EvaluationBundle/Resources/views'), '!Evaluation');
        $instance->addPath(($this->targetDirs[3].'\\src\\MessagerieBundle/Resources/views'), 'Messagerie');
        $instance->addPath(($this->targetDirs[3].'\\src\\MessagerieBundle/Resources/views'), '!Messagerie');
        $instance->addPath(($this->targetDirs[3].'\\src\\PortfolioBundle/Resources/views'), 'Portfolio');
        $instance->addPath(($this->targetDirs[3].'\\src\\PortfolioBundle/Resources/views'), '!Portfolio');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'EvaluationBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EvaluationBundle'),
                    'namespace' => 'EvaluationBundle',
                ],
                'MessagerieBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MessagerieBundle'),
                    'namespace' => 'MessagerieBundle',
                ],
                'PortfolioBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PortfolioBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'EvaluationBundle' => 'EvaluationBundle\\EvaluationBundle',
                'MessagerieBundle' => 'MessagerieBundle\\MessagerieBundle',
                'PortfolioBundle' => 'PortfolioBundle\\PortfolioBundle',
            ...
            'mailer_user' => 'naoufel.noreplay@gmail.com',
            'mailer_password' => 'symfony34',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'naoufel.noreplay@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'symfony34',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'naoufel.noreplay@gmail.com' => 'naoufel.noreplay@gmail.com',
            ],
