...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\PublicationBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ReclamationBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\EvaluationBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\MessagerieBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\PortfolioBundle\\Entity')]);

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'PublicationBundle\\Entity');
$b->addDriver($c, 'ReclamationBundle\\Entity');
$b->addDriver($c, 'EvaluationBundle\\Entity');
$b->addDriver($c, 'MessagerieBundle\\Entity');
$b->addDriver($c, 'PortfolioBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'PublicationBundle' => 'PublicationBundle\\Entity', 'ReclamationBundle' => 'ReclamationBundle\\Entity', 'EvaluationBundle' => 'EvaluationBundle\\Entity', 'MessagerieBundle' => 'MessagerieBundle\\Entity', 'PortfolioBundle' => 'PortfolioBundle\\Entity']);
